...
public class BannerLayout extends RelativeLayout {
    ...
    private int selectedIndicatorHeight = 15;
    private int selectedIndicatorWidth = 15;
    private int unSelectedIndicatorHeight = 15;
    private int unSelectedIndicatorWidth = 15;
    ...
    //添加网络图片路径
    public void setViewUrls(List<Object> urls) {
