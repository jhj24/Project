...
public class SwitchButton extends View {
    ...
    public SwitchButton(Context context, AttributeSet attrs) {
        ...
        final int DEFAULT_COLOR_PRIMARY = 0xFF366bfd;
        final int DEFAULT_COLOR_PRIMARY_DARK = 0xFF477dfd;
        ...
        colorOff = a.getColor(R.styleable.SwitchButton_offColor, 0x40000000);
        ...
        ratioAspect = a.getFloat(R.styleable.SwitchButton_ratioAspect, 0.53f);
